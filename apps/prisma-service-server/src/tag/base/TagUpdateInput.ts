...
import { LikeUpdateManyWithoutTagsInput } from "./LikeUpdateManyWithoutTagsInput";
...
class TagUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => LikeUpdateManyWithoutTagsInput,
  })
  @ValidateNested()
  @Type(() => LikeUpdateManyWithoutTagsInput)
  @IsOptional()
  @Field(() => LikeUpdateManyWithoutTagsInput, {
    nullable: true,
  })
  likes?: LikeUpdateManyWithoutTagsInput;
